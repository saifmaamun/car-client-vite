...
const Banner = () => {
  ...
  <div id="slide1" className="carousel-item relative w-full">
    ...
    <div className="absolute flex justify-start transform -translate-y-1/2 left-24 top-1/4 ">
      <h1 className='font-bold text-7xl text-start text-white'>Affordable <br />Price For Car <br /> Servicing</h1>
    </div>
    {/* hero subtitle */}
    <div className="w-1/2 absolute flex justify-start transform -translate-y-1/2 left-24 top-1/2 ">
      <p className='text-xl text-start text-white'>There are many variations of passages of  available, but <br /> the majority have suffered alteration in some form</p>
    </div>
    {/* hero button */}
